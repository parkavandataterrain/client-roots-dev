...
function CustomFieldEncounter({ tableName, tableColumns, setTableColumns }) {

    console.log("tableName, tableColumns, setTableColumns", tableName, tableColumns, setTableColumns)
...
export default CustomFieldEncounter;
