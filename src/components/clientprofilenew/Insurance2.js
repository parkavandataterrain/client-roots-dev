                    ...
                    <div className="flex flex-col justify-between space-y-6">
                        <div className="flex space-x-6">
                            <div className="flex-1">
                                <TextBox placeholder="Carrier Name" isEdittable={isEdittable} value={clientData.insurance_secondary_carrier_name}
                                    handleChange={(e) => handleFieldChange('insurance_secondary_carrier_name', e.target.value)} />
                            </div>
                        </div>
                        <div className="flex space-x-6">
                            <div className="flex-1">
                                <TextBox placeholder="Subscriber ID" isEdittable={isEdittable} value={clientData.insurance_secondary_subscriber_id}
                                    handleChange={(e) => handleFieldChange('insurance_secondary_subscriber_id', e.target.value)} />
                            </div>
                            <div className="flex-1">
                                <TextBox placeholder="Subscriber Name" isEdittable={isEdittable} value={clientData.insurance_secondary_subscriber_name}
                                    handleChange={(e) => handleFieldChange('insurance_secondary_subscriber_name', e.target.value)} />
                            </div>
                        </div>
                        <div className="flex space-x-6">
                            <div className="flex-1">
                                <DropDown placeholder="Relation to Insured" options={relationshipOptions} isEdittable={isEdittable} selectedOption={clientData.insurance_secondary_relation_to_insured}
