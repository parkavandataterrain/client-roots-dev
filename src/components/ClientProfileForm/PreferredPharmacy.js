    ...
    >
      ...
      >
        <div>
          ...
          <p>
            Kindly provide complete and valid information for Preferred Pharmacy
            section.
          </p>
        </div>
        <img
          ...
          <div className="p-4 border-t border-gray-300">
            <div className="flex flex-col justify-between space-y-6">
              <div className="flex space-x-6">
                <div className="flex-1">
                  <TextBox
                    ...
                    value={clientData.preferred_pharmacy_name}
                    handleChange={(e) =>
                      handleFieldChange(
                ...
                <div className="flex-1">
                  <TextBox
                    ...
                    isEdittable={isEdittable}
                    value={clientData.preferred_pharmacy_phone}
                    handleChange={(e) =>
                      handleFieldChange(
              ...
              <div className="flex space-x-6">
                <div className="flex-1">
                  <TextBox
                    placeholder="Pharmacy Address and Location"
                    isEdittable={isEdittable}
                    value={clientData.preferred_pharmacy_location}
                    handleChange={(e) =>
                      handleFieldChange(
