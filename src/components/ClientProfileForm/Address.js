    ...
    >
      ...
      >
        <div>
          ...
          <p>
            Kindly provide complete and valid information for the Address
            section.
          </p>
        </div>
        <img
          ...
          <div className="p-4 border-t border-gray-300">
            <div className="flex flex-col justify-between space-y-6">
              ...
              <div className="flex space-x-6">
                <div className="flex-1">
                  <TextArea
                    placeholder={`Where can we usually find you, If different from your mailing address.\n[Add Address or, If unsheltered, specify cross street, encampment address, description of dwelling, etc. ]`}
                    height={150}
                    isEdittable={isEdittable}
                    value={
                      clientData.where_can_we_usually_find_you_if_different_from_mailing_address
                    }
                    handleChange={(e) =>
                      handleFieldChange(
              ...
              <div>
                <label>do you live at this address</label>
                <div className="flex items-center justify-start gap-3 bg-white p-2">
