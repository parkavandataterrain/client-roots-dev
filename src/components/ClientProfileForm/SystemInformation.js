    ...
    >
      ...
      >
        <div>
          ...
          <p>
            Kindly provide complete and valid information for System Information
            section.
          </p>
        </div>
        <img
            ...
            <div className="flex flex-col justify-between space-y-6">
              <div className="flex space-x-6">
                <div className="flex-1">
                  <TextBox
                    placeholder="Original Data Source"
                    isEdittable={true}
                    value={clientData.system_information_original_data_source}
                    handleChange={(e) =>
                      handleFieldChange(
                ...
                <div className="flex-1">
                  <TextBox
                    ...
                    isEdittable={true}
                    value={clientData.system_information_import_notes}
                    handleChange={(e) =>
                      handleFieldChange(
                ...
                <div className="flex-1">
                  <DateInput
                    placeholder="Import Date and Time"
                    width={290}
                    isEdittable={true}
                    value={clientData.system_information_import_date}
              ...
              <div className="flex space-x-6">
                <div className="flex-1">
                  <TextBox
                    placeholder="PRN Practice Fusion"
                    isEdittable={true}
                    value={clientData.system_information_prn}
                    handleChange={(e) =>
                      handleFieldChange(
                ...
                <div className="flex-1">
                  <TextBox
                    placeholder="#"
                    isEdittable={true}
                    value={clientData.system_information_chart_number}
                    handleChange={(e) =>
                      handleFieldChange(
                ...
                <div className="flex-1">
                  <TextBox
                    placeholder="#"
                    isEdittable={true}
                    value={clientData.system_information_system_id}
                    handleChange={(e) =>
                      handleFieldChange(
              ...
              <div className="flex space-x-6">
                <div className="flex-1">
                  <TextBox
                    ...
                    isEdittable={true}
                    value={clientData.match_id}
                    handleChange={(e) =>
                      handleFieldChange("match_id", e.target.value)
                    }
                  />
                </div>
              </div>
