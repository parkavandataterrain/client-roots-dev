...
import MatchIDDirectoryTable from "./MatchIDDirectoryTable";

export default function MatchIDDirectory() {
  return (
    <div className="flex flex-column gap-2 items-center">
      <PageHeader title="Match ID Directory" />

      <div className="flex flex-column gap-2 w-100 shadow-md rounded-md">
        <MatchIDDirectoryTable />
      </div>
    </div>
  );
}
